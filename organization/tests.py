...
class WhatsAppSchedulerTestCase(TestCase):
    ...
    def test_webhook_clock_in_success(self, mock_send_text):
        ...
        self.assertIn("📍 Please share your location", mock_send_text.call_args[0][1])
    ...
    @patch('utils.whatsapp.send_whatsapp_text_message')
    def test_webhook_clock_out_success(self, mock_send_text):
        from attendance.models import Attendance
    ...
    @patch('utils.whatsapp.send_whatsapp_text_message')
    def test_webhook_clock_out_failure_no_clock_in(self, mock_send_text):
        self.org_social.office_latitude = 6.453053
        self.org_social.office_longitude = 3.395830
        self.org_social.allowed_radius = 100.0
        self.org_social.save()
    ...
    @patch('utils.whatsapp.send_whatsapp_text_message')
    def test_webhook_geofence_violation(self, mock_send_text):
        # Configure geofence on organization
        self.org_social.office_latitude = 6.453053
        self.org_social.office_longitude = 3.395830
